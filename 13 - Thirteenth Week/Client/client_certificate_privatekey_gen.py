...
"""
Author: Isaac Monroy
Title: Certificate & Private Key Generator: Client
Description:
    ...
    then be used in the client script to create a secure SSL/TLS connection.
"""
...
# Define the paths where the certificate and private key will be saved for the client
path = "./client_cert_and_privkey"
